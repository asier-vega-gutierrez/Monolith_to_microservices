...
url_single_tape = f"http://127.0.0.1:8000/calculate_single_tape_addition/?q_sand_avg={q_sand_avg}&temperature_avg={temperature_avg}"
...
url_unified_belt = f"http://127.0.0.1:8000/calculate_unified_belt_addition/?q_sand_average={q_sand_avg}&temp_average={temperature_avg}&humidity={humidity}"
...
url_unified_belt = f"http://127.0.0.1:8000/calculate_water_adittion_liters/?f_avg={f_avg}&q_sand_avg={q_sand_avg}&q_metal_avg={q_metal_avg}"
response_unified_belt = httpx.get(url_unified_belt)
