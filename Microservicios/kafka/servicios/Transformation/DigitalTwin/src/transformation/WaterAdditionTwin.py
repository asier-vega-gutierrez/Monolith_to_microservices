...
class WaterAdditionDigitalTwin(SubscriberBase):
    ...
    def add_new_mould(self, mould_data):
        ...
        if len(self._mould_queue) > self._mould_size:
            ...
            if(self._type.upper() == "DRUM"):
                ...
                produce_msg(f"{self._config.mould_data_topic}_l{self._line}", out_mould_json, out_mould.id_molde)
    ...
    def _calculate_water_addition(self):
        ...
        if self._type.upper() == 'DRUM':
            ...
            water_aditton_liters = f"http://127.0.0.1:8000/calculate_water_adittion_liters/?f_avg={f_avg}&q_sand_avg={q_sand_avg}&q_metal_avg={q_metal_avg}"
            ...
            produce_msg(f"{self._config.water_prediction_drum_topic}_l{self._line}", water_addition_data_json, addition_data.datetime.isoformat())
            ...
            url_unified_belt = f"http://127.0.0.1:8000/calculate_unified_belt_addition/?q_sand_average={q_sand_avg}&temp_average={temp_avg}&humidity={humidity}"
            ...
            produce_msg(self._config.water_prediction_unified_belts_topic, water_addition_data_json, addition_data.datetime.isoformat())
