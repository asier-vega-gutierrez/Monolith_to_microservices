...
new_topic = NewTopic(name="hello_world_demo", num_partitions=1, replication_factor=1)
...
# We delete the topic, if it is in the server
#if(new_topic.name in topics_in_server):
#    admin_client.delete_topics([new_topic.name])
#    topics_in_server = admin_client.list_topics()
#   
#    print('Topics in server: ')
#    print(topics_in_server)