...
class SensorDataExtractor():
    ...
    def _iterate_and_inject(self):
        ...
        create_topic(f"{self._config.sensor_data_topic}_l1")
        create_topic(f"{self._config.sensor_data_topic}_l2")
        ...
        while self._run:
            ...
            produce_msg(f"{self._config.sensor_data_topic}_l1", json_data_l1, data_to_send_l1.timestamp)
            ...
            produce_msg(f"{self._config.sensor_data_topic}_l2", json_data_l2, data_to_send_l2.timestamp)
