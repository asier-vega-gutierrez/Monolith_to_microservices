...
class ApplicationConfiguration(metaclass=SingletonMeta):
    ...
    def __init__(self):
        ...
        # File to read
        self.composition_file_path = str('Microservicios/DB/Repositorios/storage/file_input/data/cq.csv' if os.getenv('COMPOSITION_FILE_PATH') == None else os.getenv('COMPOSITION_FILE_PATH'))
