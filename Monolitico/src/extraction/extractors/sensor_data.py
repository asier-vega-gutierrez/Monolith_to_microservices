...
class SensorDataExtractor():
    ...
    def _iterate_and_inject(self):
        ...
        while self._run:
            ...
            self._communication_manager.data_distribution(f"{self._config.sensor_data_topic}_l1",
                                                          json_data_l1)
            ...
            self._communication_manager.data_distribution(f"{self._config.sensor_data_topic}_l2",
                                                          json_data_l2)
